...
class AppColors {
  ...
  static const Color textLightLight = Color(0xFFFFFFFF);
  static const Color textDarkLight = Color(0xFF202020);
  ...
  static const Color textLightDark = Color(0xFFDFDFDF);
  static const Color textDarkDark = Color(0xFF000000);
